...
function SocialLink({
  ...
  return (
    <a
      ...
      className="flex h-7 w-7 items-center justify-center rounded-full border border-white/10 bg-white/5 text-white/70 transition-all duration-300 hover:border-apex-blue/40 hover:bg-apex-blue/15 hover:text-white"
    >
      {type === "linkedin" && (
